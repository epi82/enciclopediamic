...
<script type="text/javascript" src="../js/form_sel_termine.js"></script> 
<script type="text/javascript" src="../js/form_mod_termine.js"></script>   
...
<table class="Table_Corpo_Admin" cellpadding="10" height="351" width="980">
 ...
 ?>  
     ...
     <script type="text/javascript">var arg="<? echo "";?>"</script>
     <script type="text/javascript">var def="<? echo "";?>"</script>
     <script type="text/javascript">var foto="<? echo "";?>"</script>   
 ...
 ?> 
     ...
     <script type="text/javascript">var arg="<? echo $arg;?>"</script>
     <script type="text/javascript">var def="<? echo $def;?>"</script>
     <script type="text/javascript">var foto=<? echo $foto;?></script>
